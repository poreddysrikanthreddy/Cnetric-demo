...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: IwCYAwcKT4TJRN/css
import Searchsvg2Icon from "./icons/PlasmicIcon__Searchsvg2"; // plasmic-import: YRD3uAIGZRQGr0/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: MF_d-Vx-kWRMgX/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Searchsvg2Icon
                className={classNames(projectcss.all, sty.svg__hWhT)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__orR)}
                role={"img"}
              />
            ),
