...
import sty from "./PlasmicButton.module.css"; // plasmic-import: dOTnf9rKr9LP8s/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__jMvHy)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__j79VH)}
                role={"img"}
              />
            ),
